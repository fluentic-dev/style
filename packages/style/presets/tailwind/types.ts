...
type TailwindDefaultSpacingKey = 0 | 'px' | 0.5 | 1 | 1.5 | 2 | 2.5 | 3 | 3.5 | 4 | 5 | 6 | 7 | 8 | 9 | 10 | 11 | 12 | 14 | 16 | 20 | 24 | 28 | 32 | 36 | 40 | 44 | 48 | 52 | 56 | 60 | 64 | 72 | 80 | 96;
...
type TailwindDefaultFontWeightKey = 'thin' | 'extralight' | 'light' | 'normal' | 'medium' | 'semibold' | 'bold' | 'extrabold' | 'black';
...
> = {
  [Scale in TailwindThemeScaleName as Scale extends keyof Base
    ? Scale
    : Scale extends keyof Override
      ? Scale
      : never]: MergeTailwindScale<Base[Scale], Override[Scale]>;
};
...
type KnownScaleKeys<Scale> = keyof NonNullable<Scale> extends infer Key
  ? Key extends ScaleKey
    ...
    : never
  : never;
type ScalePaths<Scale> = Scale extends unknown
  ? NonNullable<Scale> extends infer ResolvedScale
    ? {
...
export type TailwindRadiusValue<Theme extends TailwindTheme> = TailwindScaleValue<Theme['radii'], CssNumericValue | 'none'>;

export type TailwindFontSizeValue<Theme extends TailwindTheme> = TailwindScaleValue<Theme['fontSizes'], CssNumericValue>;
...
export type TailwindLineHeightValue<Theme extends TailwindTheme> = TailwindScaleValue<Theme['lineHeights'], CssNumericValue | 'normal'>;

export type TailwindLetterSpacingValue<Theme extends TailwindTheme> = TailwindScaleValue<Theme['letterSpacings'], CssNumericValue>;

export type TailwindShadowValue<Theme extends TailwindTheme> = TailwindScaleValue<Theme['shadows'], 'none' | CssFunctionString>;
