import type { TailwindDefaultColors, TailwindTheme } from './types';
...
} as const satisfies TailwindTheme;

export const defaultTailwindColors = defaultTailwindTheme.colors as TailwindDefaultColors;
