...
const docsOrder = [
  ...
  ['learn', 'use-scopes-for-component-styling-cases'],
  ['learn', 'expose-styleable-parts'],
  ['learn', 'theming-with-tokens'],
  ['learn', 'theming-with-values'],
  ['learn', 'create-themes'],
  ['learn', 'combine-app-and-component-themes'],
  ['learn', 'debug-styles'],
  ['learn', 'build-for-production'],
  ['learn', 'recap'],
  ...
  ['design', 'runtime-capable-compiler-optimized'],
