...
const _fluenticStyle = createExtractedStyle([['18q1j80', 'lm9gi00', [1, '--var-o2cnu50', _fluenticToken, 1]], [
  'mwx9540',
  'h44xih0',
], ['1omoamz', 'bfptscc', [1, '--var-cns3eo0', _fluenticToken2, 1]]]);
...
const _fluenticStyle3 = createExtractedStyle([
  ...
  ['1a6hjt3', 'oez5rp0'],
  ['1phh07j', 'j550dy0'],
  ['mwx9540', 'm1p2pp0', [1, '--var-g9wr0z0', _fluenticToken3, 1]],
  ['rykr7b0', 'b3cpjgx'],
  ['109h4xq', 'g0t7pm0', [1, '--var-n5tknl0', _fluenticToken4, 1]],
  ['6hmhi80', 'bc7gmho'],
  ['1ffb9qm', 'yy6azw0'],
  ['d1c10h0', 'c4ao1t0', [1, '--var-qh45190', _fluenticToken5, 1]],
  ['1omoamz', 'd64fkt0', [1, '--var-bl6zn73', _fluenticToken6, 1]],
]);
const _fluenticToken7 = createExtractedToken('1605asi', null);
const _fluenticStyle4 = createExtractedStyle([['1nca60l', 'irneu20'], ['1hznesf', 'm72p5c0'], ['2521q20', 'bpm7y8x'], [
  'mwx9540',
  'btdi9x7',
  [1, '--var-rvckzo0', _fluenticToken7, 1],
]]);
