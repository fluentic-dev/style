...
const scope = createExtractedScope([
  ...
  [4, 'pjpd9n0', 'q06n0s0', 'hover-width-g3m8co0', 1],
  [4, 'pjpd9n0', '1bc09i0', 'hover-outline-color-active-yellow-beaqvf8', 1],
  [4, 'nmrp0v0', 'yxz9kz0', 'hover-color-blue-fyds800', 1],
  [4, 'irbk3e0', '139tnz1', 'hover-opacity-jvsghe0', 1],
